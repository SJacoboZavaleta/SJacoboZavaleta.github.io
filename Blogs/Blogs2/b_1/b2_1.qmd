...
description: Paso a paso para completar el formato latex de la Revista [Norte Médico](https://revistas.unc.edu.pe/index.php/nortemedico/index).
date: last-modified
categories: 
    - "Latex"
    - "Zotero"
...
execute: 
  echo: false
---
![Página princial de Norte Médico](norteMedicopage.png)
...
```{r , out.width = '80%'}
#| label: fig-figura1
#| fig-cap: "Ejemplo de publicación"
