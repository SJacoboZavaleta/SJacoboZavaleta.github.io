...
colnames(alimentos) <- c("COD","NUM","ALIMENTO","ENERCKCAL","ENERCKJ","WATER","PROCNT",
                         ...
                         "ACFOLIC","VITC","NA")# <1>
alimentos <- alimentos[,c("COD","NUM", "ALIMENTO", "ENERCKCAL", "ENERCKJ", "WATER", "PROCNT",
                          "FAT", "CHOCDF","ZN","K","P","FE","VITA","ACFOLIC","VITC","NA")]# <1>

# Cargar datos para alimentos compuestos
platos <- read.csv("alimentosCompuestos.csv") # <2>
colnames(platos) <- c("COD","NUM","ALIMENTO","ENERCKCAL","ENERCKJ","WATER","PROCNT",
                      "FAT","CHOCDF","CHOAVL","FIBTG","ASH","CA","P","ZN","FE","VITA","THIA",
                      "RIBF","NIA","VITC","ACFOLIC","NA","K","ESTRATO") # <2>
platos <- platos[,c("COD","NUM", "ALIMENTO", "ENERCKCAL", "ENERCKJ", "WATER", "PROCNT", "FAT", "CHOCDF",
                          "ZN","K","P","FE","VITA","ACFOLIC","VITC","NA")]# <2>


# Creamos tablas de Anexo
codigo <- c("A","B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "Q", "T", "U", "SE", "SS")# <3>
categoria <- c("Cereales y derivados", "Verduras, hortalizas y derivados", "Frutas y derivados", 
               ...
               "Alimentos preparados (segundo)")# <3>
...
ui <- fluidPage(# <5>
  ...
  useShinyjs(),# <8>
  tabsetPanel(# <9>
    tabPanel("Alimentos individuales",
...
server <- function(input, output, session) {
  ...
  output$foodTable1 <- renderDataTable(# <12>
    alimentos, server = FALSE, selection = "single",
    options = list(
      pageLength = 15,
      columnDefs = list(
        list(
  ...
  output$foodTable2 <- renderDataTable(# <12>
    platos,server = FALSE,selection = "single",
    options = list(
      pageLength = 15,
      columnDefs = list(
        list(
...
[![Aplicación Shiny](images/1.png){fig-alt="Aplicación de composición de tablas de alimentos usando Shiny"}](ttps://sergiojacobozavaleta.shinyapps.io/rosaapp/)
...
::: {.g-col-12 .g-col-md-6}
Como citar  
:   Jácobo-Zavaleta, Sergio. 2024. *"Guía Nutricional con Shiny: Selección de Alimentos de la Tabla Peruana (4ta Edición)"* Third Foundation, 24 de mayo, 2024. [URL](link)
:::
